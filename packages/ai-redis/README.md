# Auth0 AI Redis Store for the [AI SDK](https://sdk.vercel.ai/)

`@auth0/ai-redis` is a secure Redis-based data store implementation for the [Auth0 AI SDK](https://sdk.vercel.ai/).

## Install

> [!WARNING]
> `@auth0/ai-redis` is currently under development and it is not intended to be used in production, and therefore has no official support.
